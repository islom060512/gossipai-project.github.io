  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-6 col-span-full animate-fade-in">
      ...
      <div className="mb-4">
        ...
        <p className="text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-200 overflow-auto max-h-40">{transcribedText}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          <h4 className="text-xl font-semibold text-purple-700 mb-2">Tone Analysis:</h4>
          <p className="text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-200">{toneAnalysis}</p>
        </div>
        <div>
          <h4 className="text-xl font-semibold text-purple-700 mb-2">Emotion Analysis:</h4>
          <p className="text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-200">{emotionAnalysis}</p>
        </div>
      </div>

      <div>
        <h4 className="text-xl font-semibold text-purple-700 mb-2">Brief Summary:</h4>
        <p className="text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-200">{briefSummary}</p>
      </div>
    </div>
  );
};
