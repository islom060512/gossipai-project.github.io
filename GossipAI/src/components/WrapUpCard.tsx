...
const WrapUpCard: React.FC<WrapUpCardProps> = ({ analysis }) => {
  return (
    <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-2xl shadow-xl p-6 col-span-full animate-fade-in">
      ...
      <p className="text-gray-700 leading-relaxed mb-4 italic">"{analysis.psychologistSummary}"</p>
      <div className="bg-white rounded-xl p-4 border border-purple-200">
        <h4 className="text-xl font-semibold text-purple-700 mb-2">My Advice:</h4>
        <p className="text-gray-800">{analysis.advice}</p>
      </div>
    </div>
  );
};
